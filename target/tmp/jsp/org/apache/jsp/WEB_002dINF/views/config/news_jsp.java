...
public final class news_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("  <body>\r\n");
      out.write("  \r\n");
      out.write("    <h3 style=\"color:#013791;\">公司新闻</h3>\r\n");
      out.write("  \r\n");
      out.write("  \t<div class=\"container\" style=\"border: 1px solid #d0d0d0 ; max-width: 680px\"  >  \r\n");
      out.write("    \t");
    ...
    try {
      ...
      if (_jspx_eval_c_forEach_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          out.write("\r\n");
          out.write("\t\r\n");
          out.write("\t\t\t\t<li style=\"margin:15px 20px\">\r\n");
          out.write("\t\t\t\t\t<a style=\"color:#333\" href=\"../config/newscontent/");
          ...
          out.write("</span>\r\n");
          out.write("\t\t\t\t</li>\r\n");
          out.write("\t\t\t\t<!-- <hr style=\"margin:10px 0px ; border-color:#d0d0d0\"> -->\r\n");
          out.write("\t\t\t\t\r\n");
          out.write("\t\t");
  ...
  private boolean _jspx_meth_fmt_formatDate_0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_forEach_0, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_forEach_0)
    ...
    _jspx_th_fmt_formatDate_0.setValue((java.util.Date) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${news.date}", java.util.Date.class, (PageContext)_jspx_page_context, null));
    _jspx_th_fmt_formatDate_0.setPattern("yyyy年MM月dd日     HH时mm分");

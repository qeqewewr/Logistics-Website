...
<body>
	...
	<form id="inputForm" action="${ctx}/story/vehicle/updatevehicle" method="post" class="form-horizontal">
		<fieldset>
			<legend><small>更新运力</small></legend>
				...
				<div class="controls"  >
					<input type="text" id="volume" name="volume"  value="${vehicle.volume}" class="input-large required"/>
				</div>
				</div>

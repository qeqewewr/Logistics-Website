...
<body>
	<form id="inputForm" action="${ctx}/frontpage/waybillstatus/setform1" method="post" class="form-horizontal">
	<input type="hidden" value="${waybill.id }" name="waybillid" >
	<input type="hidden" value="${vehicle.id }" name="vehicle"> 
		<fieldset>
			...
			<div class="control-group">
				<label class="control-label">运力:</label>
				<div class="controls">
					<span class="help-inline" style="padding:5px 0px">${vehicle.number }
					  </span>
				</div>
			</div>
